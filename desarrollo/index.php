...
//	    include 'include/generic_header.php';
	...
	<section id="section_wrap">
	    <form class="form-actions" style="margin: 15% auto 0 !important; border: 1px solid #e5e5e5 !important;  width: 220px;" action="index.php" method="POST">
                  <div style="text-align:center; width:90%;"><img src="images/logocmsblasColor.png"></div>
